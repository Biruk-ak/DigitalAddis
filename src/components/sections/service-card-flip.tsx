            ...
            >
                ...
                <div
                    className={cn(
                        ...
                        "shadow-lg",
                        "transition-all duration-700",
                        "group-hover:border-[#ddfe00] group-hover:shadow-[0_15px_50px_rgba(221,254,0,0.4)]",
                            ...
                            <div className="relative group/icon">
                                <div
                                    className={cn(
                                        ...
                                        "bg-gradient-to-br from-[#ddfe00]/20 via-[#ddfe00]/10 to-transparent"
                                    )}
                                />
                                <Repeat2 className="relative z-10 w-4 h-4 text-[#ddfe00] transition-transform duration-300 group-hover/icon:scale-110 group-hover/icon:-rotate-12" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                >
                    <div className="flex-1 space-y-6">
                        <div className="space-y-2">
                            ...
                            <p className="text-sm text-gray-400 tracking-tight transition-all duration-500 ease-out-expo group-hover:translate-y-[-2px] line-clamp-2">
                                {description}
                            </p>
                        </div>
                        ...
                        <div className="space-y-2">
                            {features.map((feature, index) => (
                                ...
                                >
                                    <ArrowRight className="w-3 h-3 text-[#ddfe00]" />
                                    <span>{feature}</span>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="pt-6 mt-6 border-t border-gray-800">
                        <div
                            className={cn(
                                ...
                                "bg-gradient-to-r from-[#1a1a1a] via-[#1a1a1a] to-[#1a1a1a]",
                                "hover:from-[#ddfe00]/10 hover:from-0% hover:via-[#ddfe00]/5 hover:via-100% hover:to-transparent hover:to-100%",
                                "hover:scale-[1.02] hover:cursor-pointer"
                            )}
                        >
                            <span className="text-sm font-medium text-white transition-colors duration-300 group-hover/start:text-[#ddfe00]">
                                View Details
                            </span>
                            <div className="relative group/icon">
                                <div
                                ...
                                />
                                <ArrowRight className="relative z-10 w-4 h-4 text-[#ddfe00] transition-all duration-300 group-hover/start:translate-x-0.5 group-hover/start:scale-110" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <style jsx>{`
                @keyframes scale {
                    0% {
                        transform: scale(2);
                        opacity: 0;
                        box-shadow: 0px 0px 50px rgba(221, 254, 0, 0.5);
                    }
                    50% {
                        transform: translate(0px, -5px) scale(1);
                        opacity: 1;
                        box-shadow: 0px 8px 20px rgba(221, 254, 0, 0.5);
                    }
                    100% {
                        transform: translate(0px, 5px) scale(0.1);
                        opacity: 0;
                        box-shadow: 0px 10px 20px rgba(221, 254, 0, 0);
                    }
                }
            `}</style>
        </div>
