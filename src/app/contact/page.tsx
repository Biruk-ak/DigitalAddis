...
export default function ContactPage() {
  ...
  return (
    <section className="bg-background relative w-full overflow-hidden py-16 md:py-24 min-h-screen">
      {/* Background gradients with #ddfe00 color */}
      <div
        className="absolute top-0 left-0 h-[500px] w-[500px] rounded-full opacity-20 blur-[120px]"
        style={{
          background: `radial-gradient(circle at center, #ddfe00, transparent 70%)`,
        }}
      />
      <div
          ...
          <div className="grid md:grid-cols-2">
            <div className="relative p-6 md:p-10" ref={formRef}>
              ...
              >
                ...
                <span className="text-[#ddfe00] relative z-10 w-full text-4xl font-bold tracking-tight italic md:text-5xl">
                  Us
                </span>
                <SparklesCore
                  id="tsparticles"
              ...
              >
                ...
                >
                  <Button
                    ...
                    className="w-full bg-gradient-to-b from-[#ddfe00] to-[#b8d400] text-black shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset] hover:from-[#ddfe00] hover:to-[#b8d400]"
                  >
                    {isSubmitting ? (
